...
```ts
import { SqlPivotTableDataModel } from "@superplot/grid";
...
Extends [PivotTableDataModel](/grid/docs/datamodel/pivot-table-datamodel#api-reference).
