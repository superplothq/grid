...
The grid pipeline is: **[DataSource](/grid/docs/datasource) → [DataModel](/grid/docs/datamodel) → ViewModel → Renderer**.
...
See [FlattenedDataViewModel](/grid/docs/viewmodel/flattened-data-viewmodel#pagination-totalrows-and-offsettop) for the full pagination explanation.
