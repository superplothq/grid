...
<a className="doc-link-card" href="/grid/docs/samples/pivot-table">
  <span className="doc-link-card-head">
    <svg className="doc-link-card-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 6l-6 6 6 6" /><path d="M16 6l6 6-6 6" /></svg>
    <span className="doc-link-card-title">Pivot Table: table algebra by example</span>
  </span>
  <span className="doc-link-card-text">Edit cross, hierarchy, and concat expressions on live pivots and see the config each one produces.</span>
</a>
