...
This is separate from the cell/row/column selection API (`selectCellByDataIndex`, etc.) which highlights individual cells. The `matchAll` API is for bulk conditional formatting.
