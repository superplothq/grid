import { PivotSliceResult, FacetData, ViewModelMetadata } from "./types";
 ...
 */
export interface PivotDataViewModelParams extends ViewModelInitParams {
