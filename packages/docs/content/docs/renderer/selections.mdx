...
description: The selectAll API selects cells by predicate - matching on facet dimension, facet value, or cell data - and applies attributes to them. Attributes include CSS styles, renderer overrides, column sizing, and data grouping tags.
---
...
grid
  ...
  .prop({
    ...
    colSize: { strategy: "clamped-width", widthInPx: 120 },
  });
```
